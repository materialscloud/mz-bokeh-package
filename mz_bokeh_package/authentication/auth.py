...
from mz_bokeh_package.utilities.helpers import get_api_key_from_query_arguments, get_auth_token_from_query_arguments
...
def get_user(request_handler: RequestHandler) -> bool | None:
    ...
    try:
        MZGraphQLClient.get_user(api_key, auth_token)
